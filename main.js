const SUPABASE_URL = "https://vcmwhrujwrhqxdsxlzjl.supabase.co";
const SUPABASE_ANON_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZjbXdocnVqd3JocXhkc3hsempsIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODA5OTE0MTEsImV4cCI6MjA5NjU2NzQxMX0.8_7NhYvr6iVvNECLN7oJ2ed_oklopc7VmgwObuOaia0";
...
function optCard(color,id,emoji,icon,title,sub){
  const onclick = id==="support"
    ? `Telegram.WebApp.openTelegramLink('https://t.me/m/ojU-kJgiMTdl')`
    : `chooseOption('${id}')`;
...
function renderUid(){
  ...
  return `<div class="screen">
    ...
    <div class="uid-card" style="animation:fadeUp .4s ease-out both">
      ...
      <button class="reg-btn" onclick="window.open('https://www.yaarwin0.com/#/register?invitationCode=784572194781','_blank')">
...
function renderResult(){
  ...
  const contactAdmin = `Telegram.WebApp.openTelegramLink('https://t.me/m/ojU-kJgiMTdl')`;
  const registerOfficial = `window.open('https://www.yaarwin0.com/#/register?invitationCode=784572194781','_blank')`;
